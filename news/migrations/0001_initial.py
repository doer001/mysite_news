    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_date', models.DateField(auto_now=True, null=True, verbose_name='更改时间')),
            ],
            options={
                'verbose_name': '教程',
        ...
        migrations.AddField(
            model_name='article',
            name='author',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='news.User', verbose_name='作者'),
        ),
        migrations.AddField(
            model_name='article',
            name='column',
